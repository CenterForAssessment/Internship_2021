...
for(mp in missperc) {
  ...
  for(mt in misstype) {
    ...
    # Apply F test fix
    for(f in as.list("L2PAN_Summaries.rda", "L2PAN_LONG_Summaries.rda",
                     "L2LMER_Summaries.rda", "L2LMER_LONG_Summaries.rda",
                     "PMM_Summaries.rda", "RQ_Summaries.rda")) {

      assign(gsub(".rda", "", f), fixFtest(get(gsub(".rda", "", f))))
