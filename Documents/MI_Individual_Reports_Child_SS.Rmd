---
title: "Source Code for Multiple Imputation Comparisons: Individual Reports, Scale Score Summaries"
...
---
title: 'Imputation Method Performance: Scale Score'
author: "AUTHOR"
...
Summary_GradeContent = Imputation_Summary_All_Methods_GC[,.("mean_pctbias" = mean(SS_Pct_Bias, na.rm = T),
                                     "mean_ci" = mean(SS_Coverage_Simp, na.rm = T),
                                     "mean_rawbias" = mean(SS_Raw_Bias, na.rm = T)),
...
Summary_GCArea = Imputation_Summary_All_Methods_GC[,.("mean_pctbias" = mean(SS_Pct_Bias, na.rm = T),
                                                  "mean_ci" = mean(SS_Coverage_Simp, na.rm = T),
                                                  "mean_rawbias" = mean(SS_Raw_Bias, na.rm = T)),
...
```{r}`r ''`
# Summary table by N quantile and imputation method
Summary_SchoolSize = Imputation_Summary_All_Methods_Global[,.("mean_pctbias" = mean(SS_Pct_Bias, na.rm = T),
                                                          "mean_ci" = mean(SS_Coverage_Simp, na.rm = T),
                                                          "mean_rawbias" = mean(SS_Raw_Bias, na.rm = T)),
                                                           keyby = .(N_QUANT, IMP_METHOD)] 
...
ggplot(Imputation_Summary_All_Methods_GC, aes(x = IMP_METHOD, y = SS_Raw_Bias)) +
...
ggplot(Imputation_Summary_All_Methods_GC, aes(x = GRADE, y = SS_Raw_Bias, fill = IMP_METHOD)) +
  geom_boxplot() + coord_flip() +
...
ggplot(Imputation_Summary_All_Methods_GC, aes(x = CONTENT_AREA, y = SS_Raw_Bias, fill = IMP_METHOD)) +
  geom_boxplot() + coord_flip() +
...
ggplot(aes(x = N, y = SS_Raw_Bias, color = IMP_METHOD)) +
  geom_point() +
...
Imputation_Summary_All_Methods_GC[, .("condmean" = mean(SS_Raw_Bias)), keyby = .(N, IMP_METHOD)] %>%
...
# Using different colors for imputation method
ggplot(Imputation_Summary_All_Methods_Global, aes(x = N, y = SS_Raw_Bias, color = IMP_METHOD)) +
  geom_point() +
...
# Scatterplot of conditional mean raw bias based on grade/content area size
Imputation_Summary_All_Methods_Global[, .("condmean" = mean(SS_Raw_Bias)), keyby = .(N, IMP_METHOD)] %>%
  ggplot(aes(x = N, y = condmean, color = IMP_METHOD)) +
  geom_point() +
...
# Using different colors for imputation method
Imputation_Summary_All_Methods_GC[order(N)] %>%
ggplot(aes(x = N, y = abs(SS_Raw_Bias), color = IMP_METHOD)) +
  geom_point() +
...
Imputation_Summary_All_Methods_GC[, .("condmean" = mean(abs(SS_Raw_Bias))), keyby = .(N, IMP_METHOD)] %>%
  ggplot(aes(x = N, y = condmean, color = IMP_METHOD)) +
  geom_point() +
...
# Scatterplot of average bias as a function of aggregated N
# Using different colors for imputation method
ggplot(Imputation_Summary_All_Methods_Global, aes(x = N, y = abs(SS_Raw_Bias), color = IMP_METHOD)) +
  geom_point() +
...
Imputation_Summary_All_Methods_Global[, .("condmean" = mean(abs(SS_Raw_Bias))), keyby = .(N, IMP_METHOD)] %>%
  ggplot(aes(x = N, y = condmean, color = IMP_METHOD)) +
  geom_point() +
...
ggplot(aes(x = Percent_Missing, y = SS_Raw_Bias, color = IMP_METHOD)) +
  geom_point() +
...
# Using different colors for imputation method
Imputation_Summary_All_Methods_GC[order(Percent_Missing)] %>%
ggplot(aes(x = Percent_Missing, y = abs(SS_Raw_Bias), color = IMP_METHOD)) +
  geom_point() +
...
ggplot(Imputation_Summary_All_Methods_GC, aes(x = IMP_METHOD, y = SS_Coverage_Simp)) +
  geom_boxplot() + coord_flip() +
...
ggplot(Imputation_Summary_All_Methods_GC, aes(x = GRADE, y = SS_Coverage_Simp, fill = IMP_METHOD)) +
  geom_boxplot() + coord_flip() +
...
ggplot(Imputation_Summary_All_Methods_GC, aes(x = CONTENT_AREA, y = SS_Coverage_Simp, fill = IMP_METHOD)) +
  geom_boxplot() + coord_flip() +
...
# Using different colors for imputation method
ggplot(Imputation_Summary_All_Methods_Global, aes(x = N, y = SS_Coverage_Simp, color = IMP_METHOD)) +
  geom_point() +
...
Imputation_Summary_All_Methods_Global[, .("condmean" = mean(SS_Coverage_Simp)), keyby = .(N, IMP_METHOD)] %>%
  ggplot(aes(x = N, y = condmean, color = IMP_METHOD)) +
  geom_point() +
  labs(x = "Aggregated School Size (Summing across Grade and Content Area)", y = "Conditional Mean Raw Bias") +
...
# Using different colors for imputation method
Imputation_Summary_All_Methods_GC[order(Percent_Missing)] %>%
ggplot(aes(x = Percent_Missing, y = SS_Coverage_Simp, color = IMP_METHOD)) +
  geom_point() +
...
ggplot(Imputation_Summary_All_Methods_GC, aes(x = IMP_METHOD, y = SS_Pct_Bias)) +
  geom_boxplot() + coord_flip() +
...
ggplot(Imputation_Summary_All_Methods_GC, aes(x = GRADE, y = SS_Pct_Bias, fill = IMP_METHOD)) +
  geom_boxplot() + coord_flip() +
...
ggplot(Imputation_Summary_All_Methods_GC, aes(x = CONTENT_AREA, y = SS_Pct_Bias, fill = IMP_METHOD)) +
  geom_boxplot() + coord_flip() +
...
# Using different colors for imputation method
ggplot(Imputation_Summary_All_Methods_Global, aes(x = N, y = SS_Pct_Bias, color = IMP_METHOD)) +
  geom_point() +
...
Imputation_Summary_All_Methods_Global[, .("condmean" = mean(SS_Pct_Bias)), keyby = .(N, IMP_METHOD)] %>%
  ggplot(aes(x = N, y = condmean, color = IMP_METHOD)) +
  geom_point() +
  labs(x = "Aggregated School Size (Summing across Grade and Content Area)", y = "Conditional Mean Raw Bias") +
...
# Using different colors for imputation method
Imputation_Summary_All_Methods_GC[order(Percent_Missing)] %>%
ggplot(aes(x = Percent_Missing, y = SS_Pct_Bias, color = IMP_METHOD)) +
  geom_point() +
...
```{r echo = T}`r ''`
# Fit models
gc.raw.imp = feols(SS_Raw_Bias ~ i(IMP_METHOD, ref = "Observed") | 
                   CONTENT_AREA^GRADE, Imputation_Summary_All_Methods_GC)
gc.raw.add = feols(SS_Raw_Bias ~ N + Percent_Missing + i(IMP_METHOD, ref = "Observed") | 
                   CONTENT_AREA^GRADE, 
                   Imputation_Summary_All_Methods_GC)
gc.raw.int = feols(SS_Raw_Bias ~ (N + Percent_Missing + i(IMP_METHOD, ref = "Observed"))^2 | 
                   CONTENT_AREA^GRADE, 
                   Imputation_Summary_All_Methods_GC)
```
...
```{r echo = T}`r ''`
# Fit models
sc.raw.imp = feols(SS_Raw_Bias ~ i(IMP_METHOD, ref = "Observed"), 
                   Imputation_Summary_All_Methods_Global)
sc.raw.add = feols(SS_Raw_Bias ~ N + Percent_Missing + i(IMP_METHOD, ref = "Observed"), 
                   Imputation_Summary_All_Methods_Global)
sc.raw.int = feols(SS_Raw_Bias ~ (N + Percent_Missing + i(IMP_METHOD, ref = "Observed"))^2, 
                   Imputation_Summary_All_Methods_Global)
```
...
```{r echo = T}`r ''`
# Fit models
gc.abs.imp = feols(abs(SS_Raw_Bias) ~ i(IMP_METHOD, ref = "Observed") | 
                   CONTENT_AREA^GRADE, Imputation_Summary_All_Methods_GC)
gc.abs.add = feols(abs(SS_Raw_Bias) ~ N + Percent_Missing + i(IMP_METHOD, ref = "Observed") | 
                   CONTENT_AREA^GRADE, 
                   Imputation_Summary_All_Methods_GC)
gc.abs.int = feols(abs(SS_Raw_Bias) ~ (N + Percent_Missing + i(IMP_METHOD, ref = "Observed"))^2 | 
                   CONTENT_AREA^GRADE, 
                   Imputation_Summary_All_Methods_GC)
```
...
```{r echo = T}`r ''`
# Fit models
sc.abs.imp = feols(abs(SS_Raw_Bias) ~ i(IMP_METHOD, ref = "Observed"), 
                   Imputation_Summary_All_Methods_Global)
sc.abs.add = feols(abs(SS_Raw_Bias) ~ N + Percent_Missing + i(IMP_METHOD, ref = "Observed"), 
                   Imputation_Summary_All_Methods_Global)
sc.abs.int = feols(abs(SS_Raw_Bias) ~ (N + Percent_Missing + i(IMP_METHOD, ref = "Observed"))^2, 
                   Imputation_Summary_All_Methods_Global)
```
...
```{r echo = T}`r ''`
# Fit models
gc.cov.imp = feglm(SS_Coverage_Simp ~ i(IMP_METHOD, ref = "Observed") | 
                   CONTENT_AREA^GRADE, 
                   Imputation_Summary_All_Methods_GC, family = "binomial")
gc.cov.add = feglm(SS_Coverage_Simp ~ N + Percent_Missing + i(IMP_METHOD, ref = "Observed") | 
                   CONTENT_AREA^GRADE, 
                   Imputation_Summary_All_Methods_GC, family = "binomial")
gc.cov.int = feglm(SS_Coverage_Simp ~ (N + Percent_Missing + i(IMP_METHOD, ref = "Observed"))^2 | 
                   CONTENT_AREA^GRADE, 
                   Imputation_Summary_All_Methods_GC, family = "binomial")
```
...
```{r echo = T}`r ''`
# Fit models
sc.cov.imp = feglm(SS_Coverage_Simp ~ i(IMP_METHOD, ref = "Observed"), 
                   Imputation_Summary_All_Methods_Global, family = "binomial")
sc.cov.add = feglm(SS_Coverage_Simp ~ N + Percent_Missing + i(IMP_METHOD, ref = "Observed"), 
                   Imputation_Summary_All_Methods_Global, family = "binomial")
sc.cov.int = feglm(SS_Coverage_Simp ~ (N + Percent_Missing + i(IMP_METHOD, ref = "Observed"))^2, 
                   Imputation_Summary_All_Methods_Global, family = "binomial")
```
